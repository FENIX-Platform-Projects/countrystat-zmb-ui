...
require([
...
], function (Catalog, Analysis, Menu, TableCreator, ChartCreator, MapCreator, MetadataViewer, FenixCommons, Filter, Compiler, FenixReports) {
    ...
    Compiler.resolve([catalogConfig, analysisConfig, menuConfig, tableCreatorConfig, chartCreatorConfig, mapCreatorConfig, metadataViewerConfig, fenixCommonConfig, filterConfig, fenixReportsConfig], {
